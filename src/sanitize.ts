...
const isDynamicFormat =
  (formatDefaults: FormatDefaults | undefined) => (format: string) =>
...
const sanitizeBySchema =
  (schema: JsonSchema, formatDefaults?: FormatDefaults) =>
  (object: PlainObject) => {
 ...
 */
const sanitize =
  (schemas: SchemaCollection, formatDefaults?: FormatDefaults) =>
